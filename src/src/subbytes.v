module subbytes (
    ...
    output wire [127:0] state_out   // 128-bit AES state after SubBytes
);

   

    aes_sbox_rom sbox0  (.addr(state_in[127:120]), .data(state_out[127:120]));
    aes_sbox_rom sbox1  (.addr(state_in[119:112]), .data(state_out[119:112]));
    aes_sbox_rom sbox2  (.addr(state_in[111:104]), .data(state_out[111:104]));
    aes_sbox_rom sbox3  (.addr(state_in[103:96]),  .data(state_out[103:96]));

    aes_sbox_rom sbox4  (.addr(state_in[95:88]),   .data(state_out[95:88]));
    aes_sbox_rom sbox5  (.addr(state_in[87:80]),   .data(state_out[87:80]));
    aes_sbox_rom sbox6  (.addr(state_in[79:72]),   .data(state_out[79:72]));
    aes_sbox_rom sbox7  (.addr(state_in[71:64]),   .data(state_out[71:64]));

    aes_sbox_rom sbox8  (.addr(state_in[63:56]),   .data(state_out[63:56]));
    aes_sbox_rom sbox9  (.addr(state_in[55:48]),   .data(state_out[55:48]));
    aes_sbox_rom sbox10 (.addr(state_in[47:40]),   .data(state_out[47:40]));
    aes_sbox_rom sbox11 (.addr(state_in[39:32]),   .data(state_out[39:32]));

    aes_sbox_rom sbox12 (.addr(state_in[31:24]),   .data(state_out[31:24]));
    aes_sbox_rom sbox13 (.addr(state_in[23:16]),   .data(state_out[23:16]));
    aes_sbox_rom sbox14 (.addr(state_in[15:8]),    .data(state_out[15:8]));
    aes_sbox_rom sbox15 (.addr(state_in[7:0]),     .data(state_out[7:0]));

endmodule


module aes_sbox_rom (
    input  wire [7:0] addr,   // input byte
    output wire [7:0] data    // substituted byte
);
