`timescale 1ns/1ps
// =============================================================================
// subbytes.v  —  AES S-box using case statement (synthesisable by Yosys)
// =============================================================================
// The array+initial style is unreliable in Yosys. A combinational case
// statement synthesises correctly to a mux tree with no equivalence issues.
// =============================================================================
...
// stub — not instantiated by aes_top, kept for Makefile compatibility
module subbytes (
    input  wire         clk,
    input  wire         rst_n,
    input  wire         start,
